...
* **Total Pixels:** 100
* **Correctness:** Integer inputs were accurately converted to their double-precision equivalents. Edge cases were verified successfully; for example, `0` mapped correctly to `0.00` and `255` to `1.00`.
...
* **Total Pixels:** 10,000
* **Correctness:** Conversion logic remained consistent with the small-scale test, maintaining accuracy across all 10,000 data points. Edge case mapping (0 and 255) remained correct.
...
* **Correctness:** Validity checks confirmed that arithmetic precision is maintained even at high volume. All inputs, including boundary values, were converted correctly.
